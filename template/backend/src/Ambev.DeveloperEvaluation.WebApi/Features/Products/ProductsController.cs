...
public class ProductsController : BaseController
{
    ...
    /// </summary>
    /// <param name="_page">The page number for pagination (default: 1)</param>
    /// <param name="_size">The number of items per page (default: 10)</param>
    /// <param name="_order">The ordering of results (e.g., "price desc, title asc")</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    public async Task<IActionResult> GetProducts([FromQuery] int? _page, [FromQuery] int? _size, [FromQuery] string? _order, CancellationToken cancellationToken)
    {
        ...
        return Ok(new PaginatedList<GetProductsResponse>(
            response,
            response.
            ));
    }
